...
[CustomEditor(typeof(SpaceshipController))]
...
public class FlightCameraEditor : Editor 
{
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.Separator();
		cam.control = (SpaceshipController) EditorGUILayout.ObjectField(new GUIContent("Flight Controller", "Drag the container object that has the Player Flight Controller here."), cam.control, typeof(SpaceshipController), true);
